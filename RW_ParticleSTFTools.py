...
def gen_delta_npart(halo_data,snaps,unique_particle_list,mass_table,vr_directory,vr_prefix,vr_files_type=2,vr_files_nested=False,vr_files_lz=3,depth=5,trim_hoes=True,verbose=True): 
    ...
    for snap in snaps:
        ...
        part_data_2=gen_particle_lists(snap,halo_data_snap=halo_data[snap],vr_directory=vr_directory,vr_prefix=vr_prefix,vr_files_type=vr_files_type,vr_files_nested=vr_files_nested,vr_files_lz=vr_files_lz,verbose=1)
        ...
        part_data_1=gen_particle_lists(snap-depth,halo_data_snap=halo_data[snap-depth],vr_directory=vr_directory,vr_prefix=vr_prefix,vr_files_type=vr_files_type,vr_files_nested=vr_files_nested,vr_files_lz=vr_files_lz,verbose=1)
